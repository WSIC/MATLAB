%% readDicomRTstruct Read the contents of a Radiotherapy Structure Set
% Usage: 
% [binaryImage, ROINames, dicomHeader, origImage, origHeader, ...
%           posMatrix] = readDicomRTstruct(dicomFile, imgDir);
%
% Input: 
...
function [binaryImage, ROINames, DCInfo, origImage, origHeader, posMatrix] = readDicomRTstruct(dicomFile,imgDir)
